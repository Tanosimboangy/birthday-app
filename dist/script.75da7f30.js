...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"containers/elements.js":[function(require,module,exports) {
"use strict";
...
},{"date-fns":"node_modules/date-fns/esm/index.js"}],"containers/html.js":[function(require,module,exports) {
"use strict";
...
function populatePersons(people) {
  ...
  sortedPeople.sort((a, b) => {
    let dayToBirthdayA = (0, _dateFns.differenceInCalendarDays)((0, _util.getNextBirthday)(a.birthday), new Date());
    let dayToBirthdayB = (0, _dateFns.differenceInCalendarDays)((0, _util.getNextBirthday)(b.birthday), new Date());
...
async function fetchPeopleList() {
  ...
  const filteringPeople = () => {
    ...
    const inputSearch = input.toLowerCase(); // I should have .trim() method in order to remove the white space.
...
fetchPeopleList();
},{"./containers/elements.js":"containers/elements.js","./containers/html.js":"containers/html.js","./img/close_popup.png":"img/close_popup.png"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
